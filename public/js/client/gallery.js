...
function initializeImages(imageArr, start, end) {
...
function handleImageNavigation(direction) {
    const currentImages = document.querySelectorAll('.gallery-image');
    const currentImageContainers = document.querySelectorAll('.image-container');
    ...
    const updatedContainers = document.querySelectorAll('.image-container');
